...
def net_2d():
    ...
    icnns, c_values = \
        dhov.start_verification(nn, test_image, eps=1, icnn_epochs=500, sample_new=False, use_over_approximation=True,
                                ...
                                adapt_lambda="none", should_plot="verification", optimizer="LBFGS", preemptive_stop=True)
